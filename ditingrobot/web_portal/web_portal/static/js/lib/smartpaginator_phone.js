    ...
    $.fn.extend({
        smartpaginator: function (options) {
            ...
            return this.each(function () {
                ...
                var inputPage = $('<input/>').attr('type', 'text').attr('class', 'jumpTxt').keydown(function (e) {
                ...
                function showLabels(pageIndex) {
                    ...
                    container.append($('<span/>').text('共'))
                        .append($('<span/>').append($('<b/>').text(Math.ceil(settings.totalrecords/settings.recordsperpage) ))).append($('<span/>').text('页'));
                }
