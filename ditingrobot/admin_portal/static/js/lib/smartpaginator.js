            ...
            return this.each(function () {
                ...
                function showLabels(pageIndex) {
                    ...
                    // .append($('<span/>').append($('<b/>').text(upper)))
                        .append($('<span/>').text('总计'))
                        .append($('<span/>').append($('<b/>').text(Math.ceil(settings.totalrecords / settings.recordsperpage) + "页")))
                        .append($('<span/>').text('-'))
                        .append($('<span/>').append($('<b/>').text(settings.totalrecords + "条")))
